			...
			<!-- @foreach($list_user as $list) -->
					<tr>
						...
						<td>
							...
							<a v-on:click.prevent="editUser(listUser.id)"  class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
			...
			<form  v-on:submit.prevent="addUser()">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						...
						<input  v-model="user.password"  type="text" class="form-control" name="password" >
						<div v-if="errors.password">{{errors.password[0]}}</div>
					</div>	
					<div class="form-group">
						<label>Role</label>
						<input  v-model="user.role"  type="text" class="form-control" name="role" >
...
export default {
 name: "AdminUser",
  ...
  methods:{
	...
	addUser(){
		axios.post('http://127.0.0.1:8000/api/add',this.user)
			.then(response => {
			 if(response.data === ""){
